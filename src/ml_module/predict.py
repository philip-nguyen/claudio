...
class Predictor:
    ...
    def generate_notes(self, model_dir, composition):

        SEQUENCE_LENGTH = 10

        print("Importing notes from disk . . .")
        # load the notes used to train the model
        with open('artifacts/notes/notes-2021_10_21-04_22_21_AM.pkl', 'rb') as filepath:
        ...
        print("Importing trained model from disk . . .")
        model = self.get_model(
            "artifacts/model/model_2021_10_11-11_28_40_PM.h5")
